...
def generateData(noise_level = 10) :
...
class test_profiles(unittest.TestCase):
    ...
    # Test a single profile plot
    #def test_profile_two_overlaid_range(self):  
    #    fig, ax = plt.subplots()
    #    profile.plot(dframe = bdata, 
    #                 xval='x', 
    #                 bins=50, 
    #                 brange=brange, 
    #                 yvals=['y', 'z'], 
    #                 axs= [ax,ax],
    #                 decos={'range' : style.style(alpha=0.2)})
    #    fig.savefig('test_profile_two_overlaid_range.png')
    #    pass
